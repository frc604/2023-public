...
public class Constants {
  public static final class Test {
    public static final double kSwerveControlFrequency = Robot.isReal() ? 250.0 : 50.0; // Hz
    public static final int antiScrubMode = 604;
  }
  ...
  public static final class IMU {
    ...
    public static final double gyroTrimZ = Math.toRadians(1.4); // rad per rotation
  }
  ...
  public static final class Intake {
    ...
    public static final class Slider {
      ...
      public static final PIDConfig sliderPIDConfig = new PIDConfig(2.4, 0.0, 0.0);
    ...
    public static final class IntakeArm {
      ...
      public static final PIDConfig armPIDConfig = new PIDConfig(2.4, 0.0, 0.0);
    ...
    public static final class Reorienter {
      ...
      public static final PIDConfig reorienterPIDConfig = new PIDConfig(2.4, 0.0, 0.0);
  ...
  public static final class Elevators {
    ...
    public static final PIDConfig zPositionPIDConfig = new PIDConfig(0.24, 0.0, 0.0);
    ...
    public static final PIDConfig xPositionPIDConfig = new PIDConfig(2.4, 0.0, 0.0);
    ...
    public static final class LeftCam {
      ...
      public static final Transform3d robotToCameraT =
          new Transform3d(
              ...
              new Rotation3d(0, 0, Units.degreesToRadians(40.0)));
  ...
  public static final class Swerve {
    ...
    public static final double steerDriveCouplingRatio = 50.0 / 14.0;
    public static final PIDConfig drivePIDConfig = new PIDConfig(0.48, 0.0, 0.0);
    public static final SimpleMotorFeedforward driveFeedforward =
        new SimpleMotorFeedforward(0.2, 2.6, 0.16343);
    public static final PIDConfig steeringPIDConfig = new PIDConfig(4.8, 0.0, 0.0);
