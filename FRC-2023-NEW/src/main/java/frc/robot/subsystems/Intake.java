...
public class Intake extends SubsystemBase {
  private static final int kSliderMotorPositionSlot = 0;
  private static final int kArmMotorAngleSlot = 0;
  private static final int kReorienterMotorAngleSlot = 0;
  ...
  private final QuixTalonFX m_sliderMotor =
      new QuixTalonFX(
          ...
          QuixTalonFX.makeDefaultConfig()
              ...
              .setPIDConfig(kSliderMotorPositionSlot, Constants.Intake.Slider.sliderPIDConfig));
  private final QuixTalonFX m_armMotor =
      new QuixTalonFX(
          ...
          QuixTalonFX.makeDefaultConfig()
              ...
              .setPIDConfig(kArmMotorAngleSlot, Constants.Intake.IntakeArm.armPIDConfig));
