...
public class QuixPigeon2 implements QuixIMU {
  ...
  public QuixPigeon2(final CANDeviceID canID) {
    ...
    reportError(
        ...
        "setStatusFramePeriod");
    reportError(
        pigeon.setStatusFramePeriod(PigeonIMU_StatusFrame.BiasedStatus_2_Gyro, 20, kCANTimeoutMs),
        "setStatusFramePeriod");
    reportError(
  ...
  public double getRoll() {
    return Math.toRadians(pigeon.getRoll());
  }

  public double getPitch() {
    return Math.toRadians(pigeon.getPitch());
  }
