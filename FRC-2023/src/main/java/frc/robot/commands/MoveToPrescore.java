...
public class MoveToPrescore extends CommandBase {
  private final Elevators m_elevatorSubsystem;
  private final Arm m_armSubsystem;

  public MoveToPrescore(Elevators elevatorSubsystem, Arm armSubsytem) {
  ...
  public void initialize() {
    m_elevatorSubsystem.moveZToPos(Constants.Elevators.zScoreHighCubeHeight);
