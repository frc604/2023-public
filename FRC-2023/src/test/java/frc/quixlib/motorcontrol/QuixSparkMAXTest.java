...
public class QuixSparkMAXTest {
  ...
  public void setup() {
    ...
    controller = new QuixSparkMAX(new CANDeviceID(0), new MechanismRatio());
    controller_follower = new QuixSparkMAX(new CANDeviceID(1), controller);

    // Inverted controller.
    controller_inverted = new QuixSparkMAX(new CANDeviceID(2), new MechanismRatio(), true);
