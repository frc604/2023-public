...
public class QuixTalonFXTest {
  ...
  public void setup() {
    ...
    controller = new QuixTalonFX(new CANDeviceID(0), new MechanismRatio());
    controller_follower = new QuixTalonFX(new CANDeviceID(1), controller);

    // Inverted controller.
    controller_inverted = new QuixTalonFX(new CANDeviceID(2), new MechanismRatio(), true);

    // Controller with ratio.
    controller_with_ratio = new QuixTalonFX(new CANDeviceID(3), new MechanismRatio(1.0, 2.0));
  ...
  @Test
  public void testSoftLimits() throws InterruptedException {
